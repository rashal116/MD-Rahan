...
export const Welcome3DModal: React.FC<Welcome3DModalProps> = ({
  ...
  }, [show, welcomeText, audioMode, customAudioUrl, playSciFiSound, speakWelcome]);
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex flex-col justify-between p-4 sm:p-8 bg-slate-950/90 backdrop-blur-xl select-none overflow-y-auto overflow-x-hidden animate-fade-in">
      ...
      <div className="relative z-10 w-full flex items-center justify-end max-w-5xl mx-auto pt-2 sm:pt-4">
        ...
        <button
          onClick={onClose}
          className="w-10 h-10 rounded-full bg-slate-900/80 border border-white/20 text-slate-300 hover:text-white hover:bg-red-500/20 hover:border-red-500/50 flex items-center justify-center transition backdrop-blur-md shadow-lg active:scale-95 cursor-pointer"
          aria-label="Close"
        >
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto my-auto py-4 sm:py-6 flex flex-col items-center text-center">
        ...
        <div className="relative mb-5 sm:mb-7 w-40 h-40 sm:w-48 sm:h-48 flex items-center justify-center">
          ...
          {/* 3. Sculpted 3D Multi-Layered Royal Glass Shield */}
          <div
          ...
          >
            ...
            <div className="w-full h-full rounded-[30px] bg-gradient-to-b from-slate-900/95 via-slate-950/90 to-black/95 backdrop-blur-xl flex flex-col items-center justify-center p-3 border border-amber-400/30 relative overflow-hidden">
              ...
              {/* 3D Golden Imperial Crown & RF Monogram or Site Logo */}
              {siteLogo ? (
                <div className="relative z-10 flex flex-col items-center justify-center">
                  <img
                    src={siteLogo}
                    alt="Logo"
                    className="w-16 h-16 sm:w-20 sm:h-20 object-contain drop-shadow-[0_0_20px_rgba(251,191,36,0.8)] animate-pulse"
                  />
                  <span className="text-[9px] font-extrabold text-amber-200/90 tracking-[0.2em] uppercase font-mono mt-1">
                    OFFICIAL PANEL
                  </span>
                </div>
              ) : (
        ...
        {/* Dynamic Official Announcement Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-amber-500/20 via-yellow-500/20 to-cyan-500/20 border border-amber-400/50 text-amber-300 text-xs sm:text-sm font-bold mb-3 shadow-[0_0_25px_rgba(251,191,36,0.35)]">
          <i className="fas fa-crown text-amber-400 animate-bounce"></i>
          <span className="tracking-wide">OFFICIAL ANNOUNCEMENT</span>
          <i className="fas fa-sparkles text-cyan-300 animate-spin"></i>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 w-full max-w-3xl mt-6 sm:mt-8 text-left">
          ...
          <div className="p-4 rounded-2xl bg-slate-900/80 border border-cyan-500/30 backdrop-blur-md shadow-[0_0_25px_rgba(56,189,248,0.15)] flex items-center gap-3.5 transform transition hover:-translate-y-1">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">১০০% অটোমেটিক এপিআই</p>
            </div>
          </div>
