...
function renderMethodLogo(method?: { label?: string; iconType?: string; logoUrl?: string; color?: string; id?: string } | null, size = 'w-7 h-7') {
  if (!method) {
    return (
      <div className={`${size} rounded-lg bg-slate-800 flex items-center justify-center text-white flex-shrink-0`}>
...
export default function App() {
  ...
  const [depositStep, setDepositStep] = useState<'amount' | 'method' | 'details'>('amount');
  ...
  const [adminSubTab, setAdminSubTab] = useState<'logo' | 'users' | 'payment' | 'deposits' | 'orders' | 'services' | 'notifications' | 'links' | 'welcome' | 'settings' | 'tasks'>('logo');
  ...
  // Save Welcome Voice & Announcement in Firestore (Admin Setting)
  const handleSaveWelcomeConfig = async () => {
    ...
    try {
      ...
      showToast('✅ ওয়েলকাম ৩D ভয়েস ও অডিও সফলভাবে সেভ হয়েছে!', 'success');
      haptic('success');
    } catch (err: any) {
  ...
  // Category Change (Single Select - Does NOT auto pick services)
  ...
  // Direct Platform Logo Click Handler (Single Select Platform & Category)
  const handleSelectPlatformLogo = (platformId: string) => {
    ...
    // Reset service so only what user clicks gets selected
    setSelectedServiceId('');
    setCurrentService(null);
    setSvcErr('');
  ...
  const executeOrderSubmission = async () => {
    ...
    try {
      ...
      haptic('success');
      showToast('🎉 অর্ডার সফলভাবে জমা হয়েছে! আপনার অর্ডার প্রসেসিং এ আছে।', 'success');
  ...
  // Proceed from Step 1 (Amount) to Step 2 (Payment Method Selection)
  ...
  // Select Payment Method (Step 2 -> Step 3: Payment Details & Number)
    ...
    <div className="max-w-[480px] mx-auto min-h-screen relative pb-28">
      ...
      {showSplash && (
        <div className="fixed inset-0 z-[9999] splash-bg flex flex-col items-center justify-center p-6 select-none overflow-hidden">
          ...
          <div className="relative mb-8 w-36 h-36 sm:w-44 sm:h-44 flex items-center justify-center animate-shield-float">
      ...
      {!showSplash && isLoggedIn && (
        <div>
          ...
          <header className="premium-header px-5 pt-7 pb-7">
            <div className="flex items-center justify-between mb-6 relative z-10">
              ...
              <div className="flex gap-1.5 items-center">
                ...
                {/* Live 3D Theme & Welcome Button */}
                <button
                  onClick={() => {
                    setShow3DThemeModal(true);
                    haptic('heavy');
                  }}
                  className="relative w-9 h-9 bg-cyan-500/15 border border-cyan-400/40 rounded-xl flex items-center justify-center text-cyan-300 cursor-pointer active:scale-95 transition hover:bg-cyan-500/25 shadow-[0_0_10px_rgba(56,189,248,0.2)]"
                  title="3D Live Theme & Welcome (3D থিম ও অ্যানিমেশন)"
                >
                  <i className="fas fa-cube text-xs text-cyan-300 animate-spin" style={{ animationDuration: '8s' }}></i>
            ...
            <div className="grid grid-cols-2 gap-3 relative z-10">
              {/* Balance Card */}
              <div className="stat-card bg-gradient-to-br from-slate-900/90 via-slate-900/60 to-blue-950/40 border border-blue-500/20 shadow-lg group">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <span className="text-[9px] font-mono text-cyan-400/80 font-bold">
                ...
                <button
                  ...
                  className="mt-2.5 w-full py-1.5 px-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-[10px] font-black uppercase tracking-wider shadow-[0_0_12px_rgba(59,130,246,0.3)] transition active:scale-95 flex items-center justify-center gap-1.5 cursor-pointer"
                >
                  <i className="fas fa-plus-circle text-amber-300 text-[10px]"></i>
                  <span>টাকা জমা (Add Funds)</span>
                </button>
              </div>

              {/* Total Orders Card */}
              <div className="stat-card bg-gradient-to-br from-slate-900/90 via-slate-900/60 to-indigo-950/40 border border-indigo-500/20 shadow-lg group">
                <div className="flex items-center justify-between mb-1.5">
                  <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="mt-2.5 w-full py-1.5 px-2.5 rounded-xl bg-slate-800/90 hover:bg-slate-700/90 border border-white/10 text-slate-200 text-[10px] font-black uppercase tracking-wider transition active:scale-95 flex items-center justify-center gap-1.5 cursor-pointer"
                >
                  <i className="fas fa-list-check text-indigo-400 text-[10px]"></i>
            ...
            <div className="mt-3 relative z-10 overflow-hidden rounded-xl bg-slate-900/80 border border-amber-500/30 p-2 flex items-center gap-2.5 shadow-md">
              <div className="flex items-center gap-1 bg-amber-500/20 text-amber-300 text-[9px] font-black px-2 py-0.5 rounded-md border border-amber-500/30 whitespace-nowrap">
                <i className="fas fa-bullhorn text-amber-400 text-[8px] animate-bounce"></i>
                <span>নোটিশ</span>
              </div>
              <div className="overflow-hidden whitespace-nowrap w-full">
                <p className="text-[10px] font-semibold text-slate-300 inline-block animate-marquee">
                  ⚡ ২৪/৭ ইনস্ট্যান্ট সার্ভিস সক্রিয় | বিকাশ, নগদ, রকেটে ইনস্ট্যান্ট ডিপোজিট বোনাস চলছে | যেকোনো প্রয়োজনে আমাদের লাইভ সাপোর্টে যোগাযোগ করুন 🚀
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-2 mt-3 relative z-10">
              ...
              <button
                ...
                className="p-2.5 rounded-xl bg-red-950/40 border border-red-500/30 hover:border-red-400/60 transition active:scale-95 flex flex-col items-center justify-center gap-1 text-center group cursor-pointer"
              >
                <div className="w-7 h-7 rounded-lg bg-red-500/20 flex items-center justify-center text-red-400 relative">
                ...
                <span className="text-[9px] font-extrabold text-slate-200 group-hover:text-white">লাইভ অর্ডার</span>
              </button>
              ...
              <button
                ...
                className="p-2.5 rounded-xl bg-amber-950/40 border border-amber-500/30 hover:border-amber-400/60 transition active:scale-95 flex flex-col items-center justify-center gap-1 text-center group cursor-pointer"
              >
                <div className="w-7 h-7 rounded-lg bg-amber-500/20 flex items-center justify-center text-amber-400">
                  <i className="fas fa-gift text-[10px]"></i>
                </div>
                <span className="text-[9px] font-extrabold text-slate-200 group-hover:text-white">টাস্ক বোনাস</span>
              </button>
              ...
              <button
                ...
                className="p-2.5 rounded-xl bg-cyan-950/40 border border-cyan-500/30 hover:border-cyan-400/60 transition active:scale-95 flex flex-col items-center justify-center gap-1 text-center group cursor-pointer"
              >
                ...
                <span className="text-[9px] font-extrabold text-slate-200 group-hover:text-white">সার্ভিস রেট</span>
              </button>
              ...
              <a
                ...
                className="p-2.5 rounded-xl bg-emerald-950/40 border border-emerald-500/30 hover:border-emerald-400/60 transition active:scale-95 flex flex-col items-center justify-center gap-1 text-center group cursor-pointer"
              >
                <div className="w-7 h-7 rounded-lg bg-emerald-500/20 flex items-center justify-center text-emerald-400">
                  <i className="fab fa-whatsapp text-[12px]"></i>
                </div>
                <span className="text-[9px] font-extrabold text-slate-200 group-hover:text-white">হোয়াটসঅ্যাপ</span>
              </a>
            </div>
          </header>
                    ...
                    return (
                      <button
                        ...
                        className={`group relative flex flex-col items-center justify-center p-2.5 rounded-2xl border transition-all duration-200 cursor-pointer active:scale-90 ${
                          isSelected
                            ? 'bg-gradient-to-b ' + platform.bg + ' border-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.4)] ring-2 ring-blue-400/40 scale-105'
                      ...
                      >
                        ...
                        {isSelected && (
                          <span className="absolute -top-1 -right-1 w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center text-white text-[8px] font-black border-2 border-[#030712] shadow-sm">
                            ✓
                          </span>
                        )}
                      </button>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] font-semibold text-slate-400">Step-by-step service order</p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <label className="form-label mb-0">
                        <i className="fas fa-magic mr-1 text-[8px]"></i> 2. Service (সার্ভিস নির্বাচন করুন)
                      </label>
                      {selectedCategory && (
                        <span className="text-[9px] text-slate-400 font-mono">
                          {allServices.filter((s) => s.category === selectedCategory).length} services
                        </span>
                      )}
                    </div>
                    ...
                    <div className="relative mb-2">
                      ...
                      >
                        <option value="" disabled>
                          {selectedCategory ? '✨ বাছুন কোন সার্ভিসটি চান...' : 'Select category first'}
                        </option>
                        {allServices
                    ...
                    {/* Interactive Service Cards for Easy Tap Selection */}
                    {selectedCategory && (
                      <div className="space-y-1.5 max-h-48 overflow-y-auto pr-1 scrollbar-thin">
                        {allServices
                          .filter((s) => s.category === selectedCategory)
                          .map((s) => {
                            const isSvcActive = selectedServiceId === s.id;
                            return (
                              <button
                                key={s.id}
                                type="button"
                                ...
                                className={`w-full text-left p-2.5 rounded-xl border transition-all flex items-center justify-between gap-2 ${
                                  isSvcActive
                                    ? 'bg-blue-600/20 border-blue-400 shadow-[0_0_12px_rgba(59,130,246,0.3)] ring-1 ring-blue-400'
                              ...
                              >
                                <div className="min-w-0 flex-1">
                                  <div className="flex items-center gap-1.5">
                                    ...
                                    <p className={`text-xs font-bold truncate ${isSvcActive ? 'text-blue-300' : 'text-slate-200'}`}>
                                      {s.name}
                                    </p>
                                  </div>
                                ...
                                <div className="text-right flex-shrink-0 bg-blue-500/10 px-2 py-1 rounded-lg border border-blue-500/20">
                                  <span className="text-xs font-extrabold text-blue-300 font-mono">
                                    ৳ {s.price}
                                  </span>
                                  <span className="text-[8px] text-slate-400 block">/1k</span>
                                </div>
                              </button>
                            );
                          })}
          ...
          )}          {/* FUNDS TAB: 2-STEP INSTANT DEPOSIT SYSTEM */}
          {activeTab === 'funds' && (
            <section className="px-4 sm:px-5 mt-5 space-y-5">
              {/* STEP 1: ENTER AMOUNT SCREEN */}
              {depositStep === 'amount' && (
                <div className="space-y-5 animate-fade-in">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[11px] text-slate-400">
                        ১ম ধাপ: কত টাকা ডিপোজিট করতে চান লিখুন
                      </p>
                    </div>
                    <div className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-blue-500/15 border border-blue-500/30 text-blue-400 text-xs font-black">
                      <span>ধাপ ১ / ২</span>
                    </div>
                  </div>

                  {/* Current Balance Hero Card */}
                  <div className="glass-card p-4 sm:p-5 text-center relative overflow-hidden bg-gradient-to-br from-blue-600/20 via-slate-900/90 to-indigo-950/40 border border-blue-500/30 shadow-xl">
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 bg-blue-500/20 rounded-2xl flex items-center justify-center text-blue-400 text-xl shadow-inner">
                          <i className="fas fa-coins text-amber-300"></i>
                        </div>
                        <div>
                          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">
                            বর্তমান একাউন্ট ব্যালেন্স
                          </p>
                      ...
                      <div className="flex items-center gap-2">
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="px-3 py-1.5 rounded-xl bg-blue-500/20 hover:bg-blue-500/30 text-blue-300 border border-blue-500/30 text-xs font-bold transition flex items-center gap-1.5"
                        >
                  ...
                  {/* AMOUNT INPUT & QUICK SELECT CARD */}
                  <div className="glass-card p-4 sm:p-6 space-y-4 border border-white/10 shadow-xl">
                    <div className="flex items-center justify-between">
                      <label className="text-xs sm:text-sm font-extrabold text-white flex items-center gap-2">
                        <i className="fas fa-hand-holding-dollar text-emerald-400"></i>
                        <span>ডিপোজিট পরিমাণ লিখুন (Deposit Amount):</span>
                      </label>
                    ...
                    <div className="relative flex items-center">
                      <div className="absolute left-4 text-2xl font-black text-blue-400 pointer-events-none select-none">
                        ৳
                      </div>
                      <input
                        type="number"
                        min="10"
                        max="100000"
                        className="w-full bg-slate-950/80 text-white font-black text-2xl sm:text-3xl pl-12 pr-4 py-3.5 rounded-2xl border-2 border-blue-500/40 focus:border-blue-400 focus:outline-none focus:ring-4 focus:ring-blue-500/20 shadow-inner tracking-tight placeholder:text-slate-600 transition"
                        placeholder="100"
                        value={depositAmount}
                        onChange={(e) => {
                    ...
                    {depAmtErr && <p className="text-xs font-bold text-red-400">⚠️ {depAmtErr}</p>}

                    {/* Quick Amount Chips */}
                    <div>
                      <span className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider block mb-2">
                        কুইক সিলেক্ট (Quick Select Amount):
                      </span>
                        ...
                        {['10', '50', '100', '200', '500', '1000', '2000', '5000'].map((amt) => {
                          ...
                          return (
                            <button
                              ...
                              className={`py-2 px-1 text-center font-black text-xs sm:text-sm rounded-xl border transition active:scale-95 cursor-pointer ${
                                isSelected
                                  ? 'bg-blue-600 text-white border-blue-400 shadow-[0_0_12px_rgba(59,130,246,0.6)] scale-105'
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 pt-2 border-t border-white/5">
                      <span className="text-[10px] font-bold text-slate-400 mr-1">টাকা যোগ/বিয়োগ:</span>
                      {[
                        { label: '+10 ৳', val: 10 },
                        { label: '+50 ৳', val: 50 },
                        { label: '+100 ৳', val: 100 },
                    ...
                    <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/20 text-xs text-blue-300 flex items-center justify-between">
                      <span className="flex items-center gap-1.5">
                        ...
                        <span>সর্বনিম্ন ডিপোজিট: <strong>৳ ১০</strong> • সর্বোচ্চ: <strong>৳ ১,০০,০০০</strong></span>
                      </span>
                      <span className="text-[10px] bg-blue-500/20 px-2 py-0.5 rounded font-bold">ইনস্ট্যান্ট এড</span>
                    </div>

                    {/* BIG NEXT BUTTON: PROCEED TO PAYMENT PAGE */}
                    <button
                      type="button"
                      onClick={handleProceedToGateway}
                      className="w-full py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-black text-base sm:text-lg shadow-[0_0_25px_rgba(59,130,246,0.5)] transition active:scale-95 flex items-center justify-center gap-3 cursor-pointer"
                    >
                      <span>পরবর্তী ধাপ: পেমেন্ট পেইজে যান</span>
              ...
              {/* STEP 2: PAYMENT GATEWAY PAGE (বিকাশ / পেমেন্ট পেইজ) */}
              {depositStep === 'gateway' && (
                <div className="space-y-4 animate-fade-in">
                  {/* Top Bar with Back Button, Step and Countdown */}
                  <div className="flex items-center justify-between gap-2">
                    <button
                      ...
                      className="px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white text-xs font-bold transition flex items-center gap-1.5 cursor-pointer border border-white/10 active:scale-95"
                    >
                      <i className="fas fa-arrow-left"></i>
                      <span>এমাউন্ট পরিবর্তন করুন</span>
                    </button>

                    <div className="flex items-center gap-2">
                      <span className="px-2.5 py-1 rounded-xl bg-emerald-500/15 text-emerald-400 text-[11px] font-bold border border-emerald-500/25 flex items-center gap-1">
                        <i className="fas fa-lock text-[10px]"></i> SSL Secured
                      </span>
                      <span className="px-2.5 py-1 rounded-xl bg-amber-500/15 text-amber-300 text-[11px] font-mono font-bold border border-amber-500/25 flex items-center gap-1">
                        <i className="fas fa-clock text-[10px]"></i>
                        {formatGatewayTimer(gatewayTimeLeft)}
                      </span>
                    </div>
                  </div>

                  {/* Summary Banner of Amount */}
                  <div className="p-3.5 rounded-2xl bg-gradient-to-r from-slate-900 to-slate-950 border border-white/15 flex items-center justify-between shadow-lg">
                    <div>
                      <span className="text-[10px] text-slate-400 uppercase font-black tracking-wider block">
                        মোট প্রদেয় টাকা (Payable Amount):
                      </span>
                    ...
                    <button
                      ...
                      className="px-3 py-1 rounded-xl bg-white/10 hover:bg-white/20 text-slate-200 text-xs font-bold transition flex items-center gap-1"
                    >
                      <i className="fas fa-edit text-xs text-amber-300"></i> এডিট
                    </button>
                  </div>

                  {/* Method Picker Tabs */}
                  <div className="glass-card p-3 border border-white/10 shadow-lg space-y-2">
                    <span className="text-xs font-extrabold text-white flex items-center gap-1.5">
                      <i className="fas fa-credit-card text-purple-400"></i>
                      <span>পেমেন্ট মেথড নির্বাচন করুন:</span>
                    </span>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      {(Object.values(paymentMethodsConfig) as PaymentMethodConfig[])
                        ...
                        .map((method) => {
                          ...
                          return (
                            <button
                              ...
                              className={`p-2.5 rounded-xl border flex items-center gap-2 cursor-pointer transition active:scale-95 ${
                                isSelected
                                  ? 'bg-slate-900 border-purple-500 shadow-[0_0_15px_rgba(168,85,247,0.35)] ring-2 ring-purple-500/80'
                                  : 'bg-slate-900/60 hover:bg-slate-900 text-slate-300 border-white/10'
                              }`}
                            >
                              <div className="p-1 rounded-lg bg-black/40 border border-white/10 flex items-center justify-center flex-shrink-0">
                  ...
                  {/* DYNAMIC BRANDED PAYMENT DETAILS & INSTRUCTIONS CARD */}
                  {(() => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-4 border-b border-white/20 pb-3">
                          <div className="flex items-center gap-2.5">
                            <div className="p-2 rounded-xl bg-white/20 backdrop-blur-sm border border-white/30">
                              {renderMethodLogo(activeCfg, 'w-7 h-7')}
                            </div>
                            <div>
                              <h3 className="font-black text-base sm:text-lg text-white">
                                {activeCfg.label} পেমেন্ট নির্দেশিকা
                              </h3>
                              <p className="text-[11px] text-white/80 font-medium">
                                নিচের নম্বরে টাকা পাঠিয়ে TrxID দিন
                              </p>
                            </div>
                          </div>

                          <div className="text-right">
                            <span className="text-[10px] text-white/80 font-bold block">প্রদেয় টাকা</span>
                            <span className="text-xl sm:text-2xl font-black text-yellow-300">
                              ৳ {parseFloat(depositAmount) || 0}
                            </span>
                          </div>
                        ...
                        {/* Exact 5 Instructions List */}
                        <div className="space-y-3 text-xs sm:text-sm font-semibold text-white/95 leading-relaxed mb-5">
                          {/* Bullet 1 */}
                          ...
                          <div className="flex items-start gap-2.5">
                            <span className="w-2.5 h-2.5 rounded-full bg-white flex-shrink-0 mt-1.5 shadow-sm"></span>
                            <span>
                              টাকা পাঠিয়ে নিশ্চিত করতে আপনার <strong>{methodLabelUpper}</strong> মোবাইল মেনু পিন লিখুন ।
                            </span>
                          </div>
                          ...
                          <div className="flex items-start gap-2.5">
                            <span className="w-2.5 h-2.5 rounded-full bg-white flex-shrink-0 mt-1.5 shadow-sm"></span>
                            <span>
                              এখন নিচের বক্সে আপনার <strong>Transaction ID</strong> দিন এবং <strong>VERIFY</strong> বাটনে ক্লিক করুন ।
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="mb-4">
                          <label className="text-xs font-black text-white block mb-1.5 uppercase tracking-wide">
                            Transaction ID (ট্রানজেকশন আইডি দিন):
                          </label>
                          <input
                            type="text"
                            className="w-full bg-white text-slate-950 font-black font-mono text-sm sm:text-base px-4 py-3 rounded-xl border-2 border-white/60 focus:border-amber-300 focus:outline-none focus:ring-4 focus:ring-amber-300/30 uppercase placeholder:text-slate-400 shadow-lg text-center tracking-wider"
                            placeholder="যেমন: BKH94A8K12"
                            value={depositTrxId}
                            onChange={(e) => {
                        ...
                        <div className="mb-5 p-3 sm:p-4 rounded-2xl bg-black/35 backdrop-blur-md border border-white/30 space-y-2">
                          ...
                          {depositReceiptImage ? (
                            ...
                            <label className="relative flex flex-col items-center justify-center p-3 rounded-xl border-2 border-dashed border-white/40 hover:border-white/80 bg-white/5 hover:bg-white/10 cursor-pointer transition text-center group">
                              <input
                                type="file"
                                accept="image/*"
                                className="hidden"
                              ...
                              />
                              <div className="w-8 h-8 rounded-full bg-white/15 flex items-center justify-center text-white mb-1 group-hover:scale-110 transition">
                                <i className="fas fa-cloud-upload-alt text-sm text-yellow-300"></i>
                              </div>
                              <span className="text-xs font-bold text-white">
                                স্ক্রিনশট নির্বাচন করতে এখানে চাপ দিন
                              </span>
                        ...
                        {activeCfg.note && (
                          <div className="mb-4 p-2.5 rounded-xl bg-black/30 border border-white/20 text-xs font-bold text-yellow-300 flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="w-full py-4 rounded-2xl bg-white hover:bg-slate-100 text-slate-950 font-black text-base sm:text-lg tracking-widest uppercase shadow-2xl transition active:scale-95 flex items-center justify-center gap-2 cursor-pointer"
                        >
                          {depositSubmitting ? (
                            <span className="loading-spinner"></span>
                          ) : (
                            <>
                              <span>VERIFY & DEPOSIT (ডিপোজিট নিশ্চিত করুন)</span>
          ...
          {activeTab === 'profile' && (
            <section className="px-4 sm:px-6 mt-4 pb-20 animate-fade-in space-y-5">
              ...
              {/* Live 3D Theme & Welcome Celebration Banner */}
              <div
                onClick={() => {
                  setShow3DThemeModal(true);
                  haptic('heavy');
                }}
                className="p-4 rounded-2xl bg-gradient-to-r from-cyan-500/20 via-blue-500/10 to-transparent border border-cyan-500/30 flex items-center justify-between cursor-pointer hover:border-cyan-400 transition active:scale-95 shadow-[0_0_20px_rgba(56,189,248,0.15)]"
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-cyan-500/25 text-cyan-300 flex items-center justify-center text-lg border border-cyan-400/40 shadow">
                    <i className="fas fa-cube text-cyan-300 animate-spin" style={{ animationDuration: '9s' }}></i>
                  </div>
                  <div>
                    <div className="flex items-center gap-1.5">
                      <h4 className="font-extrabold text-xs text-white">Live 3D থিম ও ওয়েলকাম অ্যানিমেশন</h4>
                      <span className="text-[9px] px-1.5 py-0.5 rounded bg-cyan-500/30 text-cyan-300 font-bold">3D FX</span>
                    </div>
                    <p className="text-[10px] text-cyan-200/80">3D ব্যাকগ্রাউন্ড পরিবর্তন ও ওয়েলকাম সাউন্ড দেখুন</p>
                  </div>
                </div>
                <i className="fas fa-chevron-right text-cyan-400 text-xs"></i>
              </div>
          ...
          {activeTab === 'admin' && isAdminUser && (
            <section className="px-4 sm:px-6 mt-4 pb-20 animate-fade-in">
              ...
              <div className="flex overflow-x-auto gap-2 p-1.5 bg-slate-900/90 rounded-2xl border border-white/10 mb-5 scrollbar-none">
                {[
                  { id: 'logo', label: 'হোম লোগো (Site Logo)', icon: 'fas fa-image' },
              ...
              {/* SUB TAB: SITE LOGO MANAGEMENT (হোম পেইজ ও সাইটের লোগো পরিবর্তন) */}
              {adminSubTab === 'logo' && (
                <div className="space-y-5">
                  {/* Overview Card */}
                  <div className="glass-card p-5 border border-amber-500/25 relative overflow-hidden">
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <h3 className="font-extrabold text-sm text-white">
                            হোম পেজ ও সাইটের ব্র্যান্ড লোগো (Site Logo)
                          </h3>
                          <p className="text-[11px] text-slate-400">
                            এখানে ছবি আপলোড বা লিঙ্ক দিলে তা হোম পেজ, হেডার ও স্প্ল্যাশ স্ক্রিনে সরাসরি দেখাবে
                          </p>
                        </div>
                      </div>
                      <span className="text-[9px] font-black uppercase text-amber-300 bg-amber-500/10 px-2.5 py-1 rounded-md border border-amber-500/20">
                        LIVE BRANDING 🌟
                      </span>
                    </div>

                    {/* Live Preview Showcase */}
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-4 bg-slate-950/80 rounded-2xl border border-white/10 mt-3">
                      {/* Preview 1: Header Size */}
                      <div className="flex flex-col items-center justify-center p-3 rounded-xl bg-white/5 border border-white/5 text-center">
                        <span className="text-[9px] font-bold text-slate-400 uppercase mb-2">হেডার ভিউ (Header)</span>
                        <div className="p-2 rounded-xl bg-slate-900 border border-white/10 flex items-center gap-2">
                          {adminSiteLogoInput || adminSiteLogo ? (
                            <img
                              src={adminSiteLogoInput || adminSiteLogo}
                              alt="Logo Preview"
                              className="w-10 h-10 object-contain rounded-xl p-1 bg-black/40 border border-amber-400/40"
                            />
                          ) : (
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-amber-400 to-yellow-600 flex items-center justify-center text-slate-950 font-black text-xs">
                              RF
                            </div>
                          )}
                          <div className="text-left">
                            <p className="text-[11px] font-bold text-white leading-tight">RF SMM</p>
                            <p className="text-[8px] text-emerald-400 font-mono">● LIVE</p>
                          </div>
                        </div>
                      </div>

                      {/* Preview 2: Big 3D Badge / Splash */}
                      <div className="flex flex-col items-center justify-center p-3 rounded-xl bg-white/5 border border-white/5 text-center">
                        <span className="text-[9px] font-bold text-slate-400 uppercase mb-2">স্প্ল্যাশ ও পপআপ ভিউ</span>
                        <div className="w-16 h-16 rounded-2xl p-[2px] bg-gradient-to-tr from-amber-400 via-yellow-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-amber-500/20">
                          <div className="w-full h-full rounded-[14px] bg-slate-950 flex items-center justify-center p-1.5 overflow-hidden">
                            {adminSiteLogoInput || adminSiteLogo ? (
                              <img
                                src={adminSiteLogoInput || adminSiteLogo}
                                alt="Logo Preview"
                              ...
                              <div className="text-center">
                                <i className="fas fa-crown text-amber-400 text-base"></i>
                                <span className="block text-[8px] font-black text-amber-200">RF SMM</span>
                              </div>
                            )}
                          </div>
                        </div>
                      ...
                      {/* Preview 3: Current Status */}
                      <div className="flex flex-col items-center justify-center p-3 rounded-xl bg-white/5 border border-white/5 text-center">
                        <span className="text-[9px] font-bold text-slate-400 uppercase mb-2">বর্তমান অবস্থা</span>
                        {adminSiteLogo ? (
                          <div className="space-y-1">
                            <span className="inline-block px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 text-[10px] font-bold border border-emerald-500/30">
                              ✓ কাস্টম লোগো একটিভ
                            </span>
                            <p className="text-[9px] text-slate-400 truncate max-w-[140px]">
                              {adminSiteLogo.startsWith('data:') ? 'Image File Uploaded' : adminSiteLogo}
                            </p>
                          </div>
                        ) : (
                          <div className="space-y-1">
                            <span className="inline-block px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-400 text-[10px] font-bold border border-amber-500/30">
                              ডিফল্ট রয়্যাল ক্রেস্ট
                            </span>
                            <p className="text-[9px] text-slate-400">কোন ছবি আপলোড করা নেই</p>
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="glass-card p-5 space-y-4 border border-white/10">
                    <h4 className="text-xs font-black text-white uppercase tracking-wider flex items-center gap-2">
                      ...
                      <span>১. ডিভাইস থেকে সরাসরি লোগো ছবি আপলোড করুন</span>
                    </h4>

                    {/* Drag & Drop / File Input */}
                    <div className="relative border-2 border-dashed border-blue-500/30 hover:border-blue-400 rounded-2xl p-6 text-center transition bg-blue-500/5 group">
                      <input
                        type="file"
                      ...
                      <div className="flex flex-col items-center justify-center space-y-2 pointer-events-none">
                        <div className="w-12 h-12 rounded-2xl bg-blue-500/20 flex items-center justify-center text-blue-400 text-xl group-hover:scale-110 transition">
                          <i className="fas fa-cloud-upload-alt"></i>
                        </div>
                        <p className="text-xs font-bold text-white">
                          লোগো ছবি সিলেক্ট করতে এখানে ক্লিক করুন (বা ড্রপ করুন)
                        </p>
                        <p className="text-[10px] text-slate-400">
                          PNG, JPG, WEBP বা SVG (ট্রান্সপারেন্ট ব্যাকগ্রাউন্ড লোগো সবচেয়ে ভালো দেখায়)
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center my-3">
                      ...
                      <span className="px-3 text-[10px] font-mono text-slate-500 font-bold uppercase">অথবা ইমেজ লিঙ্ক (URL)</span>
                      <div className="flex-1 h-px bg-white/10"></div>
                    </div>
                    ...
                    <div>
                      <label className="form-label text-slate-300">
                        <i className="fas fa-link mr-1 text-blue-400"></i> লোগো ছবির ডাইরেক্ট ওয়েব লিঙ্ক (URL)
                      </label>
                      <div className="flex gap-2">
                        <input
                          type="text"
                          className="input-modern text-xs"
                          placeholder="https://i.ibb.co/your-logo.png or any image link..."
                    ...
                    {/* Quick Preset Logos */}
                    <div>
                      <label className="form-label text-slate-400 text-[10px]">
                        কুইক প্রিসেট লোগো (এক ক্লিকে সেট করুন):
                      </label>
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                        {[
                          { name: 'Royal Gold SMM', url: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=200&auto=format&fit=crop&q=80' },
                          { name: 'Neon Cyber SMM', url: 'https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?w=200&auto=format&fit=crop&q=80' },
                          { name: 'Social Boost BD', url: 'https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?w=200&auto=format&fit=crop&q=80' },
                          { name: 'Diamond Shield', url: 'https://images.unsplash.com/photo-1633167606207-d840b5070fc2?w=200&auto=format&fit=crop&q=80' }
                        ].map((preset) => (
                          <button
                            key={preset.name}
                            type="button"
                            onClick={() => {
                              setAdminSiteLogoInput(preset.url);
                              haptic('light');
                              showToast(`প্রিসেট "${preset.name}" সিলেক্ট হয়েছে! সেভ বাটনে ক্লিক করুন।`, 'info');
                            }}
                            className="p-2 rounded-xl bg-white/5 border border-white/10 hover:border-amber-400/50 hover:bg-amber-500/10 transition flex items-center gap-2 text-left"
                          >
                            <img src={preset.url} alt={preset.name} className="w-7 h-7 rounded-lg object-cover flex-shrink-0" />
                    ...
                    <div className="flex flex-wrap gap-3 pt-3 border-t border-white/10">
                      <button
                        ...
                        className="btn-primary-gradient py-3 px-6 text-xs font-extrabold flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20"
                      >
                        <i className="fas fa-check-circle"></i>
                        <span>{adminSavingLogo ? 'লোগো সেভ হচ্ছে...' : 'লোগো সেভ করুন (Save Logo)'}</span>
                      </button>

                      {adminSiteLogo && (
                        <button
                          onClick={() => {
                            if (confirm('আপনি কি সত্যিই লোগো মুছে ডিফল্ট ক্রেস্টে ফিরতে চান?')) {
                              handleSaveSiteLogo('');
                            }
                          }}
                          disabled={adminSavingLogo}
                          className="px-4 py-3 bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 text-red-300 rounded-xl text-xs font-bold transition flex items-center gap-2"
                        >
                          <i className="fas fa-trash-alt"></i>
                          <span>লোগো রিমুভ (Reset Default)</span>
                        </button>
                      )}
                    </div>
                  </div>
                          ...
                          <div className="space-y-2 pt-2 border-t border-white/10">
                            ...
                            <div>
                              <label className="text-[10px] font-bold text-slate-400 block mb-1">
                                কাস্টম লোগো ছবির লিংক (Custom Logo Image URL - Optional):
                              </label>
                              <input
                                type="text"
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div>
                              <label className="text-[10px] font-bold text-slate-300 block mb-1">
                                কাস্টম লোগো ছবির লিংক (Logo Image URL):
                              </label>
                              <input
                                type="text"
                                className="input-modern text-xs py-2 px-3"
              ...
              {adminSubTab === 'welcome' && (
                <div className="glass-card p-5 space-y-5 animate-fade-in">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-white/10">
                    ...
                    <div className="flex items-center gap-2 bg-slate-900/90 px-3.5 py-1.5 rounded-xl border border-white/10">
                      <span className="text-xs font-bold text-slate-300">ওয়েলকাম স্ক্রিন:</span>
                      <button
                        onClick={() => setAdminWelcomeEnabled(!adminWelcomeEnabled)}
                      ...
                      >
                        {adminWelcomeEnabled ? '✅ চালু (ON)' : '❌ বন্ধ (OFF)'}
                      </button>
                    </div>
                  </div>
              ...
              {adminSubTab === 'settings' && (
                <div className="space-y-4">
                  {/* Embedded Welcome Voice Card in Settings as well */}
                  <div className="glass-card p-5 space-y-4 border border-cyan-500/30">
                    <div className="flex items-center justify-between">
                      <h3 className="font-extrabold text-xs text-white flex items-center gap-2">
                        <i className="fas fa-volume-up text-cyan-400"></i>
                        <span>3D ওয়েলকাম ভয়েস ও মেসেজ (Welcome Speech)</span>
                      </h3>
                      <button
                        onClick={() => setAdminSubTab('welcome')}
                        className="text-[11px] text-cyan-300 font-bold hover:underline flex items-center gap-1"
                      >
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={handleSaveWelcomeConfig}
                        disabled={adminSavingWelcome}
                        className="btn-primary-gradient py-2 px-4 text-xs font-bold flex items-center gap-1.5"
                      >
                        <i className="fas fa-save"></i>
                        <span>{adminSavingWelcome ? 'সেভ হচ্ছে...' : 'সেভ করুন'}</span>
                      </button>
                      <button
                        onClick={() => handleTestSpeech(adminWelcomeText)}
                        className="btn-secondary-solid py-2 px-3 text-xs font-bold flex items-center gap-1.5 text-cyan-300"
                      >
                        <i className="fas fa-play text-amber-300"></i>
                  ...
                  <div className="glass-card p-5 space-y-4">
                    ...
                    <div>
                      <label className="form-label">SMM Panel API Key</label>
                      <input
                        type="text"
                        className="input-modern font-mono text-xs text-amber-300 font-bold"
              ...
              <div className="relative max-w-sm w-full bg-slate-900/95 border border-cyan-500/30 rounded-[28px] p-5 shadow-[0_0_50px_rgba(56,189,248,0.25)] text-left">
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h3 className="font-extrabold text-sm text-white flex items-center gap-1.5">
                        <span>Live 3D থিম কন্ট্রোল</span>
                      ...
                      <p className="text-[10px] text-slate-400">রিয়েল-টাইম 3D ব্যাকগ্রাউন্ড ও কালার সেট করুন</p>
                    </div>
                  </div>
                  <button
                ...
                <div className="p-3 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-white">3D পার্টিকেল ও প্যারালাক্স</h4>
                      <p className="text-[10px] text-slate-400">ইন্টারেক্টিভ মোশন ও ডিপ্থ এফেক্ট</p>
                    </div>
                  </div>
                  <button
                    onClick={() => {
                ...
                >
                  <i className="fas fa-play text-amber-300"></i>
                  <span>🎉 3D ওয়েলকাম অ্যানিমেশন দেখুন (Play Welcome)</span>
                </button>
              </div>
            </div>
          )}
